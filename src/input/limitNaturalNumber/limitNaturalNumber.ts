...
import toPositiveNumber from '../limitPositiveNumber';
import type { LimitNaturalNumberOptions } from './types';
 ...
 * @returns
 */
export default function limitNaturalNumber(
  value: number | null | undefined,
  options: LimitNaturalNumberOptions = {},
